...
class IntegrationTest(TestCase):
    ...
    def test_create_search_patient(self):
        ...
        expected_patient_1 = Patient(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com",
                                     "300 Moss St, Victoria")
        expected_patient_2 = Patient(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com",
                                     "300 Moss St, Victoria")
        expected_patient_3 = Patient(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890",
        ...
        with self.assertRaises(IllegalAccessException, msg="cannot create patient without logging in"):
            self.controller.create_patient(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com",
                                           "300 Moss St, Victoria")
        ...
        self.assertEqual(actual_patient, expected_patient_1,
                         "patient John Doe was created, retrieved and their data are correct")

        # should not allow to create another patient with same phn
        with self.assertRaises(IllegalOperationException,
                               msg="cannot add a patient with a phn that is already registered"):
            self.controller.create_patient(9790012000, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com",
                                           "300 Moss St, Victoria")

        # add a second patient
        actual_patient = self.controller.create_patient(9790014444, "Mary Doe", "1995-07-01", "250 203 2020",
                                                        "mary.doe@gmail.com", "300 Moss St, Victoria")
        self.assertIsNotNone(actual_patient, "second patient created cannot be null")
        self.assertEqual(actual_patient, expected_patient_2,
                         "second patient, Mary Doe, was created and their data are correct")
        ...
        self.assertIsNotNone(actual_patient, "patient created and retrieved cannot be null")
        self.assertEqual(actual_patient, expected_patient_2,
                         "second patient, Mary Doe, was created, retrieved and their data are correct")

        # add a third patient
        actual_patient = self.controller.create_patient(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890",
                                                        "john.hancock@outlook.com", "5000 Douglas St, Saanich")
        self.assertIsNotNone(actual_patient, "patient created cannot be null")
        self.assertEqual(actual_patient, expected_patient_3,
                         "patient Joe Hancock was created and their data are correct")
        ...
        self.assertIsNotNone(actual_patient, "patient created and retrieved cannot be null")
        self.assertEqual(actual_patient, expected_patient_3,
                         "third patient, Joe Hancock, was created, retrieved and their data are correct")
        ...
        self.assertEqual(actual_patient, expected_patient_2,
                         "patient Mary Doe was created, retrieved and their data are correct regardless of search order")
        actual_patient = self.controller.search_patient(9790012000)
        self.assertIsNotNone(actual_patient, "patient created and retrieved cannot be null regardless of search order")
        self.assertEqual(actual_patient, expected_patient_1,
                         "patient John Doe was created, retrieved and their data are correct regardless of search order")
    ...
    def test_retrieve_patients(self):
        ...
        expected_patient_2 = Patient(9792226666, "Jin Hu", "2002-02-28", "278 222 4545", "jinhu@outlook.com",
                                     "200 Admirals Rd, Esquimalt")
        expected_patient_3 = Patient(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com",
                                     "300 Moss St, Victoria")
        expected_patient_4 = Patient(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com",
                                     "300 Moss St, Victoria")
        expected_patient_5 = Patient(9792225555, "Joe Hancock", "1990-01-15", "278 456 7890",
                                     "john.hancock@outlook.com", "5000 Douglas St, Saanich")
        ...
        self.controller.create_patient(9790012000, "John Doe", "2000-10-10", "250 203 1010", "john.doe@gmail.com",
                                       "300 Moss St, Victoria")
        self.controller.create_patient(9790014444, "Mary Doe", "1995-07-01", "250 203 2020", "mary.doe@gmail.com",
                                       "300 Moss St, Victoria")
    ...
    def test_update_patient(self):
        ...
        with self.assertRaises(IllegalOperationException,
                               msg="cannot update patient with a phn that is not registered"):
            self.controller.update_patient(9790017777, 9798887777, "Mary Doe", "1995-07-01", "250 203 2020",
                                           "mary.doe@gmail.com", "300 Moss St, Victoria")

        # update one patient, but keep the Patient key (personal health number) unchanged
        self.assertTrue(self.controller.update_patient(9790012000, 9790012000, "John Doe", "2000-10-10", "278 999 4041",
                                                       "john.doe@hotmail.com", "205 Foul Bay Rd, Oak Bay"),
        ...
        actual_patient = self.controller.search_patient(9790012000)
        self.assertNotEqual(actual_patient, expected_patient_3,
                            "patient has updated data, cannot be equal to the original data")
        expected_patient_3a = Patient(9790012000, "John Doe", "2000-10-10", "278 999 4041", "john.doe@hotmail.com",
                                      "205 Foul Bay Rd, Oak Bay")
        self.assertEqual(actual_patient, expected_patient_3a,
        ...
        self.assertTrue(
            self.controller.update_patient(9792225555, 9793334444, "Joe Hancock", "1990-01-15", "278 456 7890",
                                           "john.hancock@gmail.com", "200 Quadra St, Victoria"),
        ...
        self.assertNotEqual(actual_patient, expected_patient_5,
                            "patient has updated data, cannot be equal to the original data")
        expected_patient_5a = Patient(9793334444, "Joe Hancock", "1990-01-15", "278 456 7890", "john.hancock@gmail.com",
                                      "200 Quadra St, Victoria")
    ...
    def test_delete_patient(self):
        ...
        with self.assertRaises(IllegalOperationException,
                               msg="cannot delete patient with a phn that is not registered"):
    ...
    def test_list_patients(self):
        ...
        self.assertEqual(patients_list[0], expected_patient_1,
                         "patient Ali Mesbah is the only one in the list of patients")
    ...
    def test_create_search_note(self):
        ...
        self.assertEqual(actual_note, expected_note_2,
                         "note 2 was created, retrieved and its data are correct regardless of search order")
        actual_note = self.controller.search_note(1)
        self.assertIsNotNone(actual_note, "note created and retrieved cannot be null regardless of search order")
        self.assertEqual(actual_note, expected_note_1,
                         "note 1 was created, retrieved and its data are correct regardless of search order")
    ...
    def test_delete_note(self):
        ...
        self.assertFalse(self.controller.delete_note(3),
                         "cannot delete note when there are no notes for that patient record in the system")
