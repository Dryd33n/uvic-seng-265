...
################################################################################
## Form generated from reading UI file 'edit_noteqmXqFa.ui'
##
...
class Ui_edit_note(object):
    def __init__(self, create_note):
        ...
        self.edit_note_msg = QLabel(self.frame)
        self.edit_note_msg.setObjectName(u"label_2")
        font2 = QFont()
        font2.setFamilies([u"Montserrat Medium"])
        font2.setItalic(True)
        self.edit_note_msg.setFont(font2)
        self.edit_note_msg.setStyleSheet(u"color: rgb(170, 0, 0);")
        self.edit_note_msg.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout.addWidget(self.edit_note_msg)
    ...
    def retranslateUi(self, create_note):
        ...
        self.label.setText(QCoreApplication.translate("create_note", u"EDIT NOTE:", None))
        self.note_content_field.setPlaceholderText(
            QCoreApplication.translate("create_note", u"enter note content here", None))
        self.edit_note_msg.setText("")
        self.create_note_btn.setText(QCoreApplication.translate("create_note", u"EDIT ", None))
    # retranslateUi
