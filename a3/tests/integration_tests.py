...
class IntegrationTests(TestCase):
    ...
    def test_create_search_patient(self):
        ...
        actual_patient = self.controller.create_patient(9790012000, "Mary Doe", "1995-07-01", "250 203 2020",
                                                        "mary.doe@gmail.com", "300 Moss St, Victoria")
        self.assertIsNone(actual_patient,
                          "cannot create patient with same personal health number as from an existing patient")
    ...
    def test_delete_patient(self):
        ...
        self.assertFalse(self.controller.delete_patient(9790012000),
                         "cannot delete patient when there are no patients in the system")
